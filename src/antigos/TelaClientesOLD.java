 ...
 */
public class TelaClientesOLD extends javax.swing.JFrame {

    //Connection conexao = null;
    /**
     * Creates new form TelaClientes2
     */
    public TelaClientesOLD() {
        initComponents();
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaClientesOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaClientesOLD().setVisible(true);
            }
        });
    }
